...
class test {
	...
	/**
	 * The test for the Computer 2
	 * @throws FileNotFoundException
	 */
	@Test
	void Test_Computer() throws FileNotFoundException
	{
		File file= new File("testprogram");// We read a file having the encoded code
		Scanner Reader1 = new Scanner(file);//A reader for the file 
		int instructions_count=0;// The count of the lines read
		...
		String[] instructions= new String[instructions_count];//Making a string array to store the string of the code
		int i=0;
		...
		pro.run();//Run the processor;  
		//The console will output depending on the processor instructions 
		/**
		 * This time it will return  based on the instructions given from testprogram.txt( should not be in src folder while running )
		 * The Register 1 has Stored 5
		 * The Register 2 has Stored 10
		 * The Register 2 has Stored 20
		 * The Register 3 has Stored 25
		 * The processor is haulted
		 */
		System.out.println("\n\n\n\n\nTHE SECOND PROGRAM: The below is the test for Computer_3. This is a program for Fibonacci Series till 34\r\n"
				+ "	 * It will only run till the fibonacci number is less than 32 our loop will go to 34 which is in fibonacci \r\n"
				+ "	 * I have 19 different instructions testing load,branch,call,peek and pop");

	}
	/**
	 * The below is the test for Computer_3. This is a program for Fibonacci Series till 34
	 * It will only run till the fibonacci number is less than 32 our loop will go to 34 which is in fibonacci 
	 * I have 19 different instructions testing load,branch,call,peek and pop
	 * 00000000000001111000000000100001
     * 00000000000000000100000001000001
     * 00000000000000001000000010100001
     * 00000000000010000000000001100001
     * 00000000000000000100000000110101
     * 00000000000010001000000000110110
     * 00000000001010001100000000110111
     * 00000000000000000100000000110010
     * 00000000000001111000000010000001
     * 00000000000000001000000011100001
     * 00000000001110010000000001010011
     * 00000000111100000100000001110010
     * 00000000111100000100000010010010
     * 00000100000010001001000000000111
     * 00000000000010001111100000100011
     * 00000000001000000011100001100011
     * 00000000000010000011100010000011
     * 00000000000000000000000110100100
     * 00000000000000000000000000000000
	 * @throws FileNotFoundException
	 */
	@Test
	void Test_Computer_3() throws FileNotFoundException
	{
		File file= new File("TESTprogram2");// We read a file having the encoded code
		Scanner Reader1 = new Scanner(file);//A reader for the file 
		int instructions_count=0;// The count of the lines read
		while(Reader1.hasNextLine()) 
		{
		...
		pro.run();//Run the processor;  
		//The console will output depending on the processor instructions 
		// Register 1 is the one where the Fibonacci series is updated 
		System.out.println("\n\n\n\nTHE THIRD PROGRAM : \n\n\n");
	}
	/**
	 * The program three test all the three pushes
	 * The Register 1 has Stored 5
	 * PUSHED 5 to address 1023
	 * The Register 2 has Stored 10
	 * PUSHED 10 to address 1022
	 * The Register 2 has Stored 20
	 * PUSHED 20 to address 1021
	 * The Register 3 has Stored 25
	 * The processor is haulted
	 * @throws FileNotFoundException
	 */
	@Test
	void Test_Computer_3_2() throws FileNotFoundException
	{
		File file= new File("TESTprogram3");// We read a file having the encoded code
		Scanner Reader1 = new Scanner(file);//A reader for the file 
		int instructions_count=0;// The count of the lines read
		while(Reader1.hasNextLine()) 
		{
		...
		pro.run();//Run the processor;  
		//The console will output depending on the processor instructions 
		// the push should update the stack (sp--) everytime we call it and it is tested here 4
		System.out.println("\n\n\n\nTHE Forth PROGRAM : Does the fibonachi series push and pop (SO THIS IS THE TEST FOR PUSH AND POP)  \n\n\n");

	}
	@Test
	void Test_Computer_3_3() throws FileNotFoundException
	{
		File file= new File("TESTprogram4");// We read a file having the encoded code
		Scanner Reader1 = new Scanner(file);//A reader for the file 
		int instructions_count=0;// The count of the lines read
		while(Reader1.hasNextLine()) 
		{
		...
		pro.run();//Run the processor;  
		//The console will output depending on the processor instructions 
		// the push should update the stack (sp--) everytime we call it and it is tested here 
		System.out.println("\n\n\n\nTHE Fifth PROGRAM : USES CALL FOR FIBONACHI SERIES AND RETURN\n\n\n");

	}
	@Test
	void Test_Computer_3_4() throws FileNotFoundException
	{
		File file= new File("TESTprogram5");// We read a file having the encoded code
		Scanner Reader1 = new Scanner(file);//A reader for the file 
		int instructions_count=0;// The count of the lines read
		while(Reader1.hasNextLine()) 
		{
